...
echo 3;
    ...
    $obj = new dbfunctiones();
        $sql="insert into cybersecurity_brochure(name,mobile,email,company,designation,message,created_at) "
		...
		$Email_subject_user = "Thanks for Downloading Brochure of India Cyber Security Dialogue 2019.";
		$Email_subject_admin = "Details of Person details from brochure India Cyber Security";
...
//email subject
$subject = 'Download Brochure from India Cyber Security Dialogue 2019'; 

//attachment file path
$file = "file/india-cyber-security.pdf";

//email body content
$htmlContent = "Dear {$_REQUEST['name']},
    <p>Thank you for your interest in India Cyber Security Dialogue 2019.</p> 
    <p>Here is the attachment to download the India Cyber Security Dialogue 2019 Brochure.</p>";
