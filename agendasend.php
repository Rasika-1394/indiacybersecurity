...
echo 3;
    ...
    $obj = new dbfunctiones();
        $sql="insert into cybersecurity_agenda(name,mobile,email,company,designation,message,created_at) "
		...
		$Email_subject_user = "Thanks for Downloading Agenda of India Cyber Security Dialogue 2019.";
		$Email_subject_admin = "Details of Person details from agenda India Cyber Security";
...
//email subject
$subject = 'Download Agenda from India Cyber Security Dialogue 2019'; 

//attachment file path
$file = "file/ISCD-Agenda.pdf";

//email body content
$htmlContent = "Dear {$_REQUEST['name']},
    <p>Thank you for your interest in India Cyber Security Dialogue 2019.</p> 
    <p>Here is the attachment to download the India Cyber Security Dialogue 2019 Agenda.</p>";
